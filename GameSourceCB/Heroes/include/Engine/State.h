...
/*
* This class encapsulates the state create function so that NULL can be avoided
...
/*
 * Function to create the EndState which is just a NULL for the creation state function.
 */
State* CreateEndState(Engine::InputHandler& inputHandler, Engine::SDLUtilityTool& sdlUtilityTool, StateCreationData& structData);

const NULL_t NoStateCreationData = NULL;
...
{
public:
    typedef State* (*CreateStateFunc)(Engine::InputHandler& inputHandler, Engine::SDLUtilityTool& sdlUtilityTool, StateCreationData& stateCreationData);
    ...
    */
    ...
    State* CallStateCreationFunction(Engine::InputHandler& inputHandler, Engine::SDLUtilityTool& sdlUtilityTool, StateCreationData& stateCreationData);

private:

    CreateStateFunc m_createStateFunc { NULL };
};
...
public:
    ...
    */
    ...
    StateCreationFunction m_createStateFunc { NULL };
...
public:
     ...
     */
    State(Engine::InputHandler& inputHandler, Engine::SDLUtilityTool& sdlUtilityTool, StateCreationData& stateCreationData);
    virtual ~State();

...
struct DynamicStatusComponent final
{
    ...
    BusyStatusType m_busy { NONE }; // whether entity is actively doing something (busy)
    int m_busyStatusStartTime { 0 };
    int m_busyStatusTotalTime { 0 };

    IdleStatusType m_idle { STANDING };
    ActiveStatusType m_status { NA }; // whether entity is dead

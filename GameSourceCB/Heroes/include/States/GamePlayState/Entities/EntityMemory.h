...
#include <list>
#include <vector>
#include <tr1/unordered_set> // future find better implementation
...
public:
    ...
    std::tr1::unordered_set<EntityDynamicIDType> * m_querySet { NULL };
};
...
public:
    ...
    void QueryEntityWorld(std::tr1::unordered_set<EntityDynamicIDType>& entitySet, b2AABB boundingArea);
...
private:
    ...
    std::tr1::unordered_map<std::string, EntityStaticIDType> m_staticEntityMap;
};

...
public:
    ...
    ComponentsContainer(EntityMemory& entityMemory) : m_entityMemory(entityMemory) {}
...
protected:
    ...
    // of memory spatially
    T_D m_dynamicComponents[DYNAMIC_ENTITY_MEMORY_SIZE];
    T_S m_staticComponents[STATIC_ENTITY_MEMORY_SIZE];

...
public:
    ...
    GamePlayState(Engine::InputHandler& inputHandler, Engine::SDLUtilityTool& sdlUtilityTool, Engine::StateCreationData& stateCreationData);
...
private:
    ...
    // TEMPORARY
    SDL_Texture* m_targetTexture { NULL };

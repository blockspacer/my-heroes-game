...
bool EntityQuery::ReportFixture(b2Fixture* fixture)
{
    ...
    if (!fixture->IsSensor())
    {
        ...
        //while (fixtureList != NULL && !bodyAdded)
        //{
        //	// bodyAdded = ?

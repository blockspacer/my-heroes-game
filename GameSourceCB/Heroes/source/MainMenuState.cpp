...
Engine::State* CreateMainMenuState(Engine::InputHandler& inputHandler, Engine::SDLUtilityTool& sdlUtilityTool, Engine::StateCreationData& stateCreationData)
{
    return new MainMenuState(inputHandler, sdlUtilityTool, stateCreationData);
}

MainMenuState::MainMenuState(Engine::InputHandler& inputHandler, Engine::SDLUtilityTool& sdlUtilityTool, Engine::StateCreationData& stateCreationData) : State(inputHandler, sdlUtilityTool, stateCreationData)
{
    //open the file
    ...
    SDL_Surface* normalSurface = NULL;

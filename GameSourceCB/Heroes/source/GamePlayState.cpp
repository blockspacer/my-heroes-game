...
Engine::State* CreateGamePlayState(Engine::InputHandler& inputHandler, Engine::SDLUtilityTool& sdlUtilityTool, Engine::StateCreationData& stateCreationData)
{
    return new GamePlayState(inputHandler, sdlUtilityTool, stateCreationData);
}

GamePlayState::GamePlayState(Engine::InputHandler& inputHandler, Engine::SDLUtilityTool& sdlUtilityTool, Engine::StateCreationData& stateCreationData) : State(inputHandler, sdlUtilityTool, stateCreationData)

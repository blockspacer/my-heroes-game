...
{
    // start the input thread for all the states
    ...
    {
        state = stateCreationPackage.m_createStateFunc.CallStateCreationFunction(m_inputHandler, m_sdlUtilityTool, stateCreationPackage.m_stateCreationData);
    }
